  ...
  return (
    <div className="fixed top-5 left-1/2 -translate-x-1/2 z-50 flex items-center justify-center pointer-events-auto">
      <nav
        ...
        className="flex items-center gap-1 rounded-full border border-white/10 bg-[#111318]/90 p-1.5 backdrop-blur-2xl shadow-[0_12px_40px_rgba(0,0,0,0.8)]"
      >
        {/* Navigation Tabs */}
        {tabs.map((tab) => {
        ...
        <div className="px-2.5 py-1 text-[11px] font-mono text-[#A8A29E] hidden sm:flex items-center gap-1.5">
